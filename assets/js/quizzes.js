...
/* ---- Aha-moment library (v2 result engine, QUIZ_RESULT_ENGINE.md §2) ----
   ...
   pattern) — an ordered rule chain, never random. Each entry:
   name (short label), heading (block title), explanation (2-3 moves:
   name the user's state → the evolved mechanism → the reframe; always
   about the USER's own mind, never about another person's feelings),
   practice { name, text, mechanism } (one somatic micro-practice). */
window.MYSTICDO_AHA = {
  choice_friction: {
    name: 'The two-future freeze',
    heading: 'Why you can\u2019t just decide',
    explanation: 'Your hesitation has nothing to do with picking the \u201Cright path\u201D \u2014 it is about postponing a loss. As long as you delay the final call, you get to keep both futures at once. In the environment our nervous systems were built for, a wrong move cost more than a missed chance, so we evolved a hyper-sensitivity to loss. Facing two real options, your body reads two predators \u2014 and the \u201CI can\u2019t decide\u201D feeling is the freeze response doing its ancient job. It isn\u2019t a character flaw. It is an outdated survival reflex, and it can be worked with.',
    practice: {
      name: 'The Somatic Coin Toss',
      text: 'Assign each path to heads and tails. Flip a coin \u2014 and pay attention only to the split-second feeling in your gut while it is in the air, not to how it lands.',
      mechanism: 'It bypasses analysis paralysis and reads your somatic intuition about loss directly.'
    }
  },
  scarcity_panic: {
    name: 'The watchdog that won\u2019t stand down',
    heading: 'Why your alarm won\u2019t switch off',
    explanation: 'Part of your mind treats anxiety as a protective amulet: as long as you stay hyper-vigilant \u2014 re-reading messages, measuring the gaps, tracking the warmth \u2014 nothing bad can sneak up on you. It feels like actively solving the problem. It isn\u2019t; it is a false sense of control with an ancient pedigree. The ancestors who relaxed through the lean seasons didn\u2019t survive them; the ones who panicked early did. Your nervous system is still hoarding against a famine \u2014 only right now, what it hoards is certainty about another person. That isn\u2019t weakness. It is an old watchdog doing its job too well.',
    practice: {
      name: 'The Somatic Descent',
      text: 'When the panic spikes, place one hand on your belly and breathe into it for three slow breaths.',
      mechanism: 'It pulls anxiety generated by an imagined future back into the safety of the present body.'
    }
  },
  boundary_invasion: {
    name: 'The protection fee',
    heading: 'Why you keep holding it all together',
    explanation: 'Over-giving is rarely pure kindness \u2014 most often it is a covert transaction: surrender your boundaries, buy a guarantee against being left. Humans are pack animals. For most of our evolutionary history, exile from the group was a death sentence, so the fear of rupture lives deep in the body. When you hold a whole connection together by yourself \u2014 the plans, the check-ins, the repair work \u2014 you are paying an old protection fee: safety, purchased with your own outline. Naming that isn\u2019t an accusation. It is the first time the transaction becomes visible.',
    practice: {
      name: 'The DND Barrier',
      text: 'Put your phone on Do Not Disturb for exactly one hour this evening.',
      mechanism: 'You physically enforce a limit and prove to your nervous system that setting one does not end in abandonment.'
    }
  },
  sudden_loss: {
    name: 'The oldest alarm',
    heading: 'Why this hurts out of proportion',
    explanation: 'Grief this size isn\u2019t an overreaction \u2014 it is an outdated one. For most of human history, losing a core attachment figure genuinely threatened survival, and the amygdala still files a breakup under mortal danger. That is why the pain is physical, and why the mind keeps the question open: as long as it isn\u2019t resolved, some part of you gets to believe the connection isn\u2019t over. Your prefrontal cortex knows this is a breakup; your limbic system thinks you are walking toward death. You are not broken \u2014 you are running the oldest alarm there is.',
    practice: {
      name: 'The Object Quarantine',
      text: 'Take the one small item that triggers the sharpest memory and put it in a box, out of sight, for seven days. Not thrown away \u2014 paused.',
      mechanism: 'It lowers the environmental triggers that keep hijacking the amygdala.'
    }
  },
  toxic_loop: {
    name: 'The familiarity loop',
    heading: 'Why familiar pain keeps winning',
    explanation: 'If unclear love keeps feeling like the love worth waiting for, there is a reason, and it isn\u2019t weakness. A nervous system optimizes for survival, not happiness. Known territory \u2014 even harsh known territory \u2014 proved yesterday that you can survive it. Unknown calm has no such track record, so the brain files familiar pain as a safe zone and reads healthy uncertainty as a threat. The loop repeats because it feels like control. Seeing the filing error is what breaks it \u2014 not willpower.',
    practice: {
      name: 'The Temperature Shock',
      text: 'When you feel the pull toward the old pattern, run cold water over your wrists for ten seconds.',
      mechanism: 'It triggers the mammalian dive reflex and forcibly interrupts the impulse loop.'
    }
  },
  illusion_fixation: {
    name: 'The pattern-making machine',
    heading: 'Why your mind keeps writing the story',
    explanation: 'A human mind evolved to over-connect dots: mistaking wind for a tiger cost a startle; mistaking a tiger for wind cost a life. Evolution heavily rewarded over-imagination \u2014 and that same machinery now runs on the messages, the silences, the almost-signs, manufacturing plot in a vacuum. An undefined or unavailable person is the perfect screen for it: never enough reality to interrupt the story. The intensity feels like information. Most of it is projection \u2014 which is why one more round of decoding never settles anything.',
    practice: {
      name: 'The Containment Protocol',
      text: 'Set a timer for ten minutes. Let yourself obsess completely \u2014 then, when it rings, stop and do a physical chore.',
      mechanism: 'Instead of suppressing the loop (which makes it rebound), you give it a strict container.'
    }
  },
  stagnation_void: {
    name: 'The energy-saving strike',
    heading: 'Why standing still feels safer than moving',
    explanation: 'Feeling directionless is rarely laziness \u2014 it is an energy calculation. In environments where calories were scarce, the first directive was simple: don\u2019t burn energy without a clear threat or a clear reward. When the brain computes that the current environment\u2019s return on effort is too low, it cuts the dopamine supply and parks you in a kind of psychological hibernation. Stagnation is the safest harbor available \u2014 no trial, no error, no cost. The way out isn\u2019t a bigger goal. It is a smaller signal that movement is safe again.',
    practice: {
      name: 'The Micro-Chaos Protocol',
      text: 'Wear one color, or one piece of jewelry, you haven\u2019t touched in months.',
      mechanism: 'A weak but undeniable signal of change disrupts the paralysis that perfectionism feeds on.'
    }
  },
  identity_crisis: {
    name: 'The submission signal',
    heading: 'Why you discount yourself first',
    explanation: 'Self-deprecation is a top-tier defense strategy: trample yourself first, and no one else\u2019s judgment can land. Among primates, an individual reaching for a higher position invites suppression \u2014 so the nervous system learned to broadcast \u201CI\u2019m not a threat\u201D before anyone asks. The imposter feeling after a real achievement is that ancient submission signal, fired in a world that no longer needs it. It once kept you safe in the hierarchy. Today it mostly keeps you small.',
    practice: {
      name: 'The Avatar Update',
      text: 'Change your phone wallpaper to an image of who you are becoming \u2014 not who you were.',
      mechanism: 'A visual anchor steadies the transition between old and new identity.'
    }
  }
};

/* ---- Recommendation layer (QUIZ_RESULT_ENGINE.md §3.1) ----
   The result page never hardcodes a vendor. CTAs resolve through this
   map: "<slug>:<practiceKey>" → { href, label, partner, disclosure }.
   Empty = CTA falls back to the on-site practice page (today's
   behavior). When an offer is configured, the renderer swaps the href,
   adds rel="sponsored nofollow" + target="_blank", and prints the
   disclosure line. Suppliers (affiliate, own products, a future reader
   marketplace) change here — copy and engine never do. */
window.MYSTICDO_OFFERS = window.MYSTICDO_OFFERS || {};

/* ---- Partner offers (QUIZ_RESULT_ENGINE.md §3.6) ----
   The affiliate supply layer: live-reading platforms presented as one
   curated block right after the aha layer. Data-driven — adding or
   swapping a partner means editing this list only. Each entry:
   key (analytics id), name (wordmark text, lowercase per brand),
   logo (icon asset), tag (formats line), offer (the new-client deal,
   shown as a pill), pitch, cta, note (offer activation line), href
   (affiliate link — TUNE macros are replaced at click time). */
window.MYSTICDO_PARTNERS = [
  {
    key: 'kasamba',
    name: 'kasamba',
    logo: '/assets/partners/kasamba-icon.svg',
    tag: 'Love psychics · chat & phone · 24/7',
    offer: '3 minutes free + 50% off',
    pitch: 'Talk it through with a love psychic by chat or phone, any hour. The first 3 minutes with each new advisor are free \u2014 long enough to feel whether they connect with your situation \u2014 and registering through this link takes 50% off your first full reading.',
    cta: 'Claim your free minutes',
    note: 'New customers \u00b7 the offer activates when you register through this link',
    href: 'https://bargestech.go2cloud.org/aff_c?offer_id=191&aff_id=2326&url=https%3A%2F%2Fwww.kasamba.com%2Flove-relationships%2F%3Fclickid%3D{transaction_id}%26utm_content%3Dsubid2%26utm_medium%3Daffiliation_tune%26utm_source%3D{affiliate_id}-{affiliate_name}'
  },
  {
    key: 'purplegarden',
    name: 'purple garden',
    logo: '/assets/partners/purplegarden-icon.svg',
    tag: 'Love advisors · video, voice & chat',
    offer: '$30 free credit',
    pitch: 'Prefer seeing the person who reads for you? Purple Garden\u2019s top-rated love advisors work over live video, voice, and chat \u2014 and a new account opened through this link starts with $30 in free reading credit.',
    cta: 'Claim your $30 credit',
    note: 'New customers \u00b7 the credit is applied when you join through this link',
    href: 'https://bargestech.go2cloud.org/aff_c?offer_id=30&aff_id=2326&url=https%3A%2F%2Fwww.purplegarden.co%2Flove-readings%3Fclickid%3D{transaction_id}%26utm_content%3Dsubid2%26utm_medium%3Daffiliation_tune%26utm_source%3D{affiliate_id}-{affiliate_name}'
  }
];
...
window.mysticdoPartnerOffersHTML = function () {
  ...
  function star() {
    return '<svg viewBox="0 0 24 24" fill="currentColor" width="11" height="11" aria-hidden="true"><path d="M12 2l2.4 7.4H22l-6.2 4.5 2.4 7.4L12 17 5.8 21.3l2.4-7.4L2 9.4h7.6z"/></svg>';
  }
  var cards = partners.map(function (p) {
    return '<div class="offer-card">'
      + '<div class="offer-logo-row">'
      + '<img class="offer-logo" src="' + esc(p.logo) + '" alt="" width="30" height="30" loading="lazy" decoding="async">'
      + '<span class="offer-wordmark">' + esc(p.name) + '</span>'
      + '</div>'
      + '<p class="offer-tag">' + esc(p.tag) + '</p>'
      + '<span class="offer-pill">' + star() + ' ' + esc(p.offer) + '</span>'
      + '<p class="offer-pitch">' + esc(p.pitch) + '</p>'
      + '<div class="offer-action">'
      + '<a class="offer-cta" data-partner="' + esc(p.key) + '" href="' + esc(p.href) + '" target="_blank" rel="sponsored nofollow">' + esc(p.cta) + ' &rarr;</a>'
      + '<p class="offer-note">' + esc(p.note) + '</p>'
      + '</div>'
      + '</div>';
  }).join('');
  return '<div class="love-offers">'
    ...
    + '<p class="love-offers-disclosure">Partner links: we may earn a commission at no extra cost to you. Offers are for new customers, are set by each platform, and may change \u2014 current terms on their sites.</p>'
    + '</div>';
};
...
window.mysticdoPatternResult = function (ctx, slug, opts) {
  ...
  /* v2 layer 3: deterministic aha match (QUIZ_RESULT_ENGINE.md §2).
     Skips silently when the quiz or library can't provide it — the
     result page must never fail on an optional layer. */
  var ahaKey = null, aha = null;
  if (v2 && typeof QZ.matchAha === 'function' && window.MYSTICDO_AHA) {
    try {
      ahaKey = QZ.matchAha(a, patternKey);
      aha = window.MYSTICDO_AHA[ahaKey] || null;
      if (!aha) ahaKey = null;
    } catch (e) { ahaKey = null; aha = null; }
  }

  /* v2 layer 7: recommendation-layer resolution (§3.1). An active
     offer swaps the CTA target and adds sponsored disclosure; with no
     offer configured the CTA keeps pointing at the on-site page. */
  var offer = null, ctaHref = p.href, ctaText = p.cta;
  if (v2) {
    offer = (window.MYSTICDO_OFFERS || {})[slug + ':' + practiceKey] || null;
    if (offer && offer.href) ctaHref = offer.href;
    if (opts.ctaText) {
      ctaText = opts.ctaText[a.want + ':' + practiceKey]
        || opts.ctaText['*:' + practiceKey]
        || p.cta;
    }
  }
  ...
  /* Block 2 (v2) — the aha layer: why this question hooks the user,
     explained through their own psychology, plus one free micro-
     practice. Inserted between interpretation and the gap so the
     emotional peak lands before the ask. */
  if (aha) {
    html += '<div class="love-block love-aha">'
      + '<h3>' + esc(aha.heading) + '</h3>'
      + '<p>' + esc(aha.explanation) + '</p>'
      + '<div class="love-aha-practice">'
      + '<span class="love-aha-practice-label">Tonight, try this</span>'
      + '<p><strong>' + esc(aha.practice.name) + '.</strong> ' + esc(aha.practice.text) + '</p>'
      + '<p class="love-aha-mechanism">' + esc(aha.practice.mechanism) + '</p>'
      + '</div>'
      + '</div>';
  }

  /* Layer 3.6 (v2) — partner offers: the curated live-reading supply
     layer, placed right after the emotional peak of the aha block so
  ...
  /* Block 3 — the information gap. v2 renders the two-sided "honest
     edge" panel (what the pattern CAN tell you / what it can't), whose
     can't-side bridge sentence is the CTA fuel; v1 keeps the single
     don't-tell block. */
  if (v2 && opts.canTell) {
    html += '<div class="love-block love-edge">'
      + '<h3>The honest edge of this pattern</h3>'
      + '<div class="love-edge-grid">'
      + '<div class="love-edge-col">'
      ...
      + '<h4>What it can\u2019t</h4>'
      + '<p>' + esc(r.dontTell) + '</p>'
      + '<p class="love-edge-bridge">' + esc(opts.edgeBridge || 'A quiz can organize your question \u2014 it can\u2019t determine what another person privately thinks, feels, or plans. That takes either a direct conversation, or a deeper reading focused on your specific situation.') + '</p>'
      + '</div>'
      + '</div>'
      + '</div>';
  } else {
  ...
  /* Practice match. v2: the decision layer — one best-fit practice,
     "based on your answers" framing, a personalized gold CTA resolved
     through the recommendation layer. v1: the quieter exploration
     framing. The honest tail (secondary / choose / tips) is shared. */
  var wantText = optionText('want', a.want);
  html += '<div class="love-match">';
  if (v2) {
    html += '<h3 class="love-match-title">Your best-fit next step</h3>'
      + '<p class="love-match-intro">Based on your answers, this is the most relevant next step \u2014 matched to what you said you most want to know: \u201C' + esc(wantText) + '.\u201D</p>'
      ...
      + '<a class="btn btn-gold" data-love-cta data-offer-key="' + esc(slug + ':' + practiceKey) + '" href="' + esc(ctaHref) + '"' + (offer ? ' target="_blank" rel="sponsored nofollow"' : '') + '>' + esc(ctaText) + ' &rarr;</a>'
      + (offer && offer.disclosure ? '<p class="love-offer-disclosure">' + esc(offer.disclosure) + '</p>' : '')
      + '</div>';
  } else {
    html += '<h3 class="love-match-title">Where a practice fits \u2014 and where it doesn\u2019t</h3>'
  ...
  html += '<div class="result-secondary-card">'
  ...
  /* Partner-offer clicks (§3.6) — the core affiliate KPI. Guarded:
     test stubs may not implement querySelectorAll. */
  var partnerCtas = ctx.body.querySelectorAll ? ctx.body.querySelectorAll('[data-partner]') : [];
...
window.MYSTICDO_QUIZZES = {
  ...
  'does-he-love-me': {
    ...
    launchSub: 'Eight questions, about two minutes. It works outward from you \u2014 your situation, what changed, what you actually want to know \u2014 and ends on the step that fits.',
    ...
    /* ---- Aha matching (result engine v2, QUIZ_RESULT_ENGINE.md §2) ----
       Ordered rule chain, specific → general; first match wins and the
       final rule is the quiz-level default, so every answer set maps to
       exactly one explanation. Deterministic: same answers, same aha. */
    matchAha: function (a, pattern) {
      /* 1. A wait-or-leave question is a decision freeze, not a feelings question. */
      if (a.want === 'wait') return 'choice_friction';
      /* 2. A fresh ending with an open loop runs the separation alarm. */
      if ((a.status === 'exes' || a.status === 'separated') &&
          (a.trigger === 'distant' || a.trigger === 'changed' || a.trigger === 'conflict' || a.want === 'still')) {
        return 'sudden_loss';
      }
      /* 3. One-sided maintenance is boundary surrender. */
      if (pattern === 'uneven') return 'boundary_invasion';
      /* 4. A "complicated" relationship with mixed/unclear pattern is the familiarity loop. */
      if (a.status === 'complicated' && (pattern === 'mixed' || pattern === 'genuine-connection')) {
        return 'toxic_loop';
      }
      /* 5. Too little data + a question this big = pattern-making in a vacuum. */
      if (pattern === 'not-enough-evidence') return 'illusion_fixation';
      /* 6. Anxiety with a steady pattern is hypervigilance, not evidence. */
      if (a.trigger === 'unknown' && (pattern === 'consistent' || pattern === 'genuine-connection')) {
        return 'scarcity_panic';
      }
      /* 7. "Something I can't name" with data present = projection. */
      if (a.want === 'beneath' || a.trigger === 'unknown') return 'illusion_fixation';
      /* 8. Default: attachment hypervigilance — the core of this question. */
      return 'scarcity_panic';
    },
    ...
    customResult: function (ctx) {
      window.mysticdoPatternResult(ctx, 'does-he-love-me', {
        resultV2: true,
        canTell: [
          'Which kind of uncertainty you\u2019re actually carrying \u2014 a closure question, a decision question, or a pattern question',
          'Which behavior pattern is making the relationship hard to read',
          'Which kind of guidance fits the question you\u2019re really asking'
        ],
        edgeBridge: 'A quiz can organize your question \u2014 it can\u2019t determine what another person privately thinks, feels, or plans. That part takes either his words, or a deeper reading focused on your specific situation.',
        ctaText: {
  ...
  'does-he-think-about-me': {
    ...
    title: 'Why Is This on Your Mind?',
    launchSub: 'Eight questions, about two minutes. Start with why it keeps pulling at you \u2014 then read how the connection actually behaves, and end on the step that fits.',
  ...
  'does-my-crush-like-me-back': {
    ...
    title: 'What Do You Want to Happen Next?',
    ...
    launchSub: 'Eight questions, about two minutes. Get clear on what you want to happen next \u2014 then see what the signals so far add up to, and the move worth considering.',
    questions: [
  ...
  'is-he-the-one': {
    id: 'is-he-the-one',
    title: 'What Does Your Gut Already Know?',
    ...
    launchSub: 'Eight questions, about two minutes. Your gut already has a read \u2014 the check turns it into something you can look at: where it\u2019s strong, and where it\u2019s still open.',
    questions: [
  ...
  'does-he-miss-me': {
    id: 'does-he-miss-me',
    title: 'A Sign to Reach Out \u2014 or Let Go?',
    launchSub: 'Eight questions, about two minutes. Name what you\u2019re really looking for \u2014 closure, a reason to reach out, or peace with the silence \u2014 and end on the step that fits.',
  ...
  'is-he-serious-about-me': {
    ...
    title: 'What Would Make You Feel Sure?',
    launchSub: 'Eight questions, about two minutes. Name what would actually settle it for you \u2014 then read which way things are moving, and end on the step that fits.',
